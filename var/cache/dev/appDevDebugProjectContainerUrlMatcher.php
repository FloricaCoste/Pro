...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/basket')) {
            // product_details_basket_index
            if (rtrim($pathinfo, '/') === '/basket') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'product_details_basket_index');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\Product_detailBasketController::indexAction',  '_route' => 'product_details_basket_index',);
            }

            // product_details_basket_add
            if (0 === strpos($pathinfo, '/basket/add') && preg_match('#^/basket/add/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'product_details_basket_add')), array (  '_controller' => 'AppBundle\\Controller\\Product_detailBasketController::addToProduct_detailsCart',));
            }

            // product_details_basket_clear
            if ($pathinfo === '/basket/clear') {
                return array (  '_controller' => 'AppBundle\\Controller\\Product_detailBasketController::clearAction',  '_route' => 'product_details_basket_clear',);
            }

            // product_details_basket_delete
            if (0 === strpos($pathinfo, '/basket/delete') && preg_match('#^/basket/delete/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'product_details_basket_delete')), array (  '_controller' => 'AppBundle\\Controller\\Product_detailBasketController::deleteAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/user')) {
            if (0 === strpos($pathinfo, '/userrole')) {
                // userrole_index
                if (rtrim($pathinfo, '/') === '/userrole') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_userrole_index;
                    }

                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($pathinfo.'/', 'userrole_index');
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\userROLEController::indexAction',  '_route' => 'userrole_index',);
                }
                not_userrole_index:

                // userrole_new
                if ($pathinfo === '/userrole/new') {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_userrole_new;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\userROLEController::newAction',  '_route' => 'userrole_new',);
                }
                not_userrole_new:

                // userrole_show
                if (preg_match('#^/userrole/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_userrole_show;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'userrole_show')), array (  '_controller' => 'AppBundle\\Controller\\userROLEController::showAction',));
                }
                not_userrole_show:

                // userrole_edit
                if (preg_match('#^/userrole/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_userrole_edit;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'userrole_edit')), array (  '_controller' => 'AppBundle\\Controller\\userROLEController::editAction',));
                }
                not_userrole_edit:
                ...
                if (preg_match('#^/userrole/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'userrole_delete')), array (  '_controller' => 'AppBundle\\Controller\\userROLEController::deleteAction',));
                }
                not_userrole_delete:
